                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="col-auto">
                                                <input type="email" value="<?= $_SESSION['username']; ?>" class="form-control" readonly>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="col-auto">
                                                <input type="password" class="form-control" readonly><br>
                                                <a href="resetPassword.php" class="btn btn-danger mt-10">Klik Untuk Ganti Password!</a>
                                            </div>
